...
#This file generates a transformer unit and deals with all the handling of it. The code is taken from  
#"The annotated Transformer", on Harvard website, by Alexander Rush.
